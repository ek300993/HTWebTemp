# Site content — what we have, what we need

Everything currently written on the site, plus a list of what still needs to come
from you. Work through it in any order; the two sections that block launch are
**Must be replaced** and **Photos to collect**.

Each line of copy is marked:
...
## 1. Must be replaced before launch
...
I wrote the contents lists by looking at your photos and guessing. Some items are
probably wrong.
...
- **Minimum 1600px on the longest edge.** Straight off a phone is fine.
- Shoot or crop with room around the basket — the site crops some images.
- Natural light, plain-ish background. Your existing photos are the right look.
...
| Instagram line | See what's in the studio this week: | Draft |
| Copyright | © Happy Turtle Custom Gifts · Handmade with love | Draft |
...
| Where | Current text | |
|---|---|---|
| Heading | Ready to create something special? | **Yours** |
...
| Where | Current text | |
|---|---|---|
| Page not found | This page wandered off — We couldn't find what you were looking for, but there are plenty of lovely things this way. | Draft |
| No search results | No matches — try a different word, or browse all baskets. | Draft |
